...
type TaskServiceClient interface {
	SubmitTask(ctx context.Context, in *Task, opts ...grpc.CallOption) (*TaskId, error)
...
func (c *taskServiceClient) SubmitTask(ctx context.Context, in *Task, opts ...grpc.CallOption) (*TaskId, error) {
...
func (c *taskServiceClient) RetrieveTask(ctx context.Context, in *TaskId, opts ...grpc.CallOption) (*Task, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Task)
	err := c.cc.Invoke(ctx, TaskService_RetrieveTask_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taskServiceClient) PollTasks(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Task], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &TaskService_ServiceDesc.Streams[0], TaskService_PollTasks_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
type TaskServiceServer interface {
	SubmitTask(context.Context, *Task) (*TaskId, error)
...
func (UnimplementedTaskServiceServer) SubmitTask(context.Context, *Task) (*TaskId, error) {
	return nil, status.Error(codes.Unimplemented, "method SubmitTask not implemented")
}
func (UnimplementedTaskServiceServer) RetrieveTask(context.Context, *TaskId) (*Task, error) {
	return nil, status.Error(codes.Unimplemented, "method RetrieveTask not implemented")
}
...
func _TaskService_RetrieveTask_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TaskId)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TaskServiceServer).RetrieveTask(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TaskService_RetrieveTask_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TaskServiceServer).RetrieveTask(ctx, req.(*TaskId))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _TaskService_PollTasks_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(emptypb.Empty)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(TaskServiceServer).PollTasks(m, &grpc.GenericServerStream[emptypb.Empty, Task]{ServerStream: stream})
}
...
var TaskService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "orchestrator.TaskService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _TaskService_RetrieveTask_Handler,
		},
		{
